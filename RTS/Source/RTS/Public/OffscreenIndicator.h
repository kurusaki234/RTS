 ...
 */
UCLASS()
class RTS_API UOffscreenIndicator : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /**
    ...
    * @outparam	OutRotationAngleDegrees - The angle to rotate a hud element if you want it pointing toward the offscreen indicator, 0Åã if onscreen
